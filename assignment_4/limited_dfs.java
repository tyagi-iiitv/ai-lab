...
public class limited_dfs {
	...
	String str = "120453786"; // initial state
	...
	int limit = 10; //counter for limit
	int unique = -1;
...
public static void main(String args[]){
    limited_dfs e = new limited_dfs("120453786", "123456780");              // New Instance of the EightPuzzle
    }
limited_dfs(String str,String goal){
